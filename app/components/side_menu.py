        ...
        super().__init__(
            ...
            content=ft.Column(
                ...
                controls=[
                    ...
                    self.menu_button("Construções", 5, on_navigate),
                    self.menu_button("Laboratório", 6, on_navigate),
                    ...
                    self.menu_button("Expedições", 13, on_navigate),
                    ft.Divider(color=ft.Colors.WHITE),
                    self.menu_button("Estruturas Avançadas", 14, on_navigate),
                    ...
                    self.menu_button("Luas", 15, on_navigate),
                    ft.Divider(color=ft.Colors.WHITE),
                    self.menu_button("Arquivos", 16, on_navigate),
                    self.menu_button("Log de Combates", 17, on_navigate),
                    self.menu_button("Simuladores", 18, on_navigate),
                    self.menu_button("Rankings", 19, on_navigate),
                    ft.Divider(color=ft.Colors.WHITE),
                    self.menu_button("Aliança", 20, on_navigate),
                    self.menu_button("Comunidade", 21, on_navigate),
                    self.menu_button("Mercado", 22, on_navigate),
                    ft.Divider(color=ft.Colors.WHITE),
                    self.menu_button("Eventos Cósmicos", 23, on_navigate),
                    self.menu_button("Loja", 24, on_navigate),
                ]
            )
        )
